...
def get_answer(chat_history: list) -> dict:
    ...
    print("DEBUG MESSAGE:", last_user_message)
...
#      {
#          "role": "assistant",
#          "content": "Evolution is the scientific theory describing how all life forms on Earth change over successive generations."
#      },
