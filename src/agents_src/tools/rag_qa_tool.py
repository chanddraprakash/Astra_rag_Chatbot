...
def rag_query_tool(query: str) -> dict:
    ...
    Returns both the generated answer and the source file names from which the
    ...
    source_file_names = {
        m.get("file_name")
        for m in getattr(response, "metadata", {}).values()
    }
...
# output = rag_query_tool(query="Explain what is python.")
# print(output)
# print(output["answer"])
